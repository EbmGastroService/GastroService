...
public class Einkauf{	
	...
	public Einkauf(String Datum,String gegenkonto,String Betrag,String BruttoNetto,String KassaBank,String Steuer,String Wo){		
		this.Datum=Datum;
		this.Wo=Wo;
	...
	void Jb(){		
		...
		new JB(Datum,B,GegenKonto,konto,""+(-NettoBetrag),""+-Vorsteuer,Wo);
	}
	...
	public static void main(String[]args){
		if(args.length>2){
			new Einkauf(args[0],args[1],args[2],args[3],args[4],args[5],args[6]);			
		}else new Einkauf("251207","1610","550","Brutto","Kassa","10","Kassa");
	}
