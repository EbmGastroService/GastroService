...
public class update{
	 ...
	 */
	public update(String suchDif,String vfile,String path,String deklar){
		//init();
		jahrDirs();//jahr
		dif=suchDif;		
		suchZiels();//suchZiel		
		zeig(los(vfile.toLowerCase(),path.toLowerCase(),deklar.toLowerCase()));		
		zeig("....Ende gesammt Update "+deklar+"..."+new com.units.myDatum().ist());
	}
	public update(String suchDif,String vfile,String path,String deklar,String aktMonat){
		//init();
		jahrDirs();//jahr
		dif=suchDif;		
		suchZiels();				
		...
		zeig(".......Ende Update .............."+deklar+""+aktMonat);
	}
	void jahrDirs(){
	...
	/*public static void main(String[]args){
		...
		new update("/","gastro/date/fliste.dat","gastro","FL",adatum);
		new update("/","gastro/date/kbuch.dat","gastro","KB",adatum);
		new update("N","gastro/date/kon.dat","gastro","KO",adatum);//adatum);//);
		//new update();	
	}*/
}
