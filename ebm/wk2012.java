...
//import ebm.*;
import ver6.*;
public class wk2012 extends JApplet{ 
	String WK_Code;
	String WR_Code="";	
	JTextArea tb;	
	JButton printme;
	...
	public wk2012 (String a_WK_Code)  {
	...
	public wk2012 (String a_WK_Code , String a_WR_Code){
		WK_Code = a_WK_Code ;
		WR_Code = a_WR_Code;
		xy = 0;
    ...
    class ll implements ListSelectionListener {   
        ...
        public void F_init(){
       	...
       	public static void main(String[] args) {
       		...
       		new wk2012("R120706N15K0000X00013E").codegesucht();
